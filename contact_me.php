...
if($_POST)
{
    ...
    //provjerava je li postoji ajax zahtjev
    if(!isset($_SERVER['HTTP_X_REQUESTED_WITH']) AND strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) != 'xmlhttprequest') {
        
        $output = json_encode(array( //kreira JSON data
            'type'=>'error', 
    ...
    //filtrira ulazne podatke sa PHP filter_var().
    ...
    if(!filter_var($country_code, FILTER_VALIDATE_INT)){ 
